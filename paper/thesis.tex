...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figs/ch6_single_cbtpu_dpjdot_5_to_2_confusion.pdf}
        \caption{CBTPU-DJDOT}
    \end{subfigure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figs/ch6_single_cbtpu_dpjdot_5_to_2_tsne_domain.pdf}
        \caption{CBTPU-DJDOT}
    \end{subfigure}
