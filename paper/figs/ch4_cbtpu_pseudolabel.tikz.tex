...
\node[anchor=north west] at (0.72,7.43) {基础信息};
...
\node[anchor=north west] at (12.12,7.43) {可靠接收门控};
...
\node[anchor=north west] at (16.42,7.43) {均衡目标学习};
