...
\node[chip, minimum width=2.75cm] at (13.65,3.55)
    {接收比例上限\\[-1pt]$\kappa,\,H(q^{\mathrm{ot}})$};
...
\node[chip, minimum width=3.65cm] at (18.50,6.20)
    {类别均衡伪监督\\[-1pt]$\mathcal{L}_{\mathrm{pl}},\ \hat{\pi}_c$};
\node[chip, minimum width=3.65cm] at (18.50,4.95)
    {强弱增强一致性\\[-1pt]$\mathcal{L}_{\mathrm{cons}}$};
\node[chip, minimum width=3.65cm] at (18.50,3.70)
    {信息最大化辅助\\[-1pt]$\mathcal{L}_{\mathrm{im}}$};
...
\node at (12.40,0.92)
    ...
    +\lambda_{\mathrm{pl}}\mathcal{L}_{\mathrm{pl}}
    +\lambda_{\mathrm{cons}}\mathcal{L}_{\mathrm{cons}}
    +\lambda_{\mathrm{im}}\mathcal{L}_{\mathrm{im}}$};
